...
class QiblahCompassWidget extends StatelessWidget {
  final _compassSvg = SvgPicture.asset('assets/images/compass.svg',width: width()*0.8);
      ...
      builder: (_, AsyncSnapshot<QiblahDirection> snapshot) {
        ...
        return Column(
          children: [
            ...
            Text(LocaleKeys.directionQibla.tr(),style: Theme.of(context).textTheme.titleMedium),
            SizedBox(height: height()*0.02),
            Text(LocaleKeys.phoneHorizontal.tr(),style: TextStyle(
